...
public sealed class CommandLongMessageInfo : IMavlinkTargetedMessageInfo<CommandLongMavlinkMessage>
{
	...
	/// <summary>
	/// target_system/target_component are core fields — present in v1 and v2 alike.
	/// </summary>
	public bool TargetFieldsAreExtensions => false;

	public IMavlinkPayloadSerializer<CommandLongMavlinkMessage> PayloadSerializer { get; }
		= new Payload.CommandLongPayloadSerializer();
