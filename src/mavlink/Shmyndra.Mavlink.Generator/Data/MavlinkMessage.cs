...
public record MavlinkMessage
{
	...
	/// </summary>
	public ImmutableArray<MavlinkMessageField> Fields { get; init; }
	...
	/// <param name="fields">The array of fields in the Mavlink message.</param>
	/// <exception cref="ArgumentNullException">Thrown when <paramref name="name"/> is <c>null</c>.</exception>
	public MavlinkMessage(
		uint id,
		string name,
		string? description,
		ImmutableArray<MavlinkMessageField> fields,
