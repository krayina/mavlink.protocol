...
public record GeneratedMavlinkEnum : MavlinkEnum
{
	...
	/// </summary>
	public ImmutableList<GeneratedMavlinkEnumEntry> GeneratedEntries { get; init; }
	...
	/// <param name="generatedEntries">The list of generated entries.</param>
	...
	internal GeneratedMavlinkEnum(string @namespace, ImmutableList<GeneratedMavlinkEnumEntry> generatedEntries, MavlinkEnum original)
		: base(original)
	{
		Namespace = @namespace ?? throw new ArgumentNullException(nameof(@namespace));
		GeneratedEntries = generatedEntries ?? throw new ArgumentNullException(nameof(generatedEntries));
	}
}
