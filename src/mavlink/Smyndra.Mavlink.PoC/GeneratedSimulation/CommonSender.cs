...
//{
//	public static ValueTask SendAsync(this MavlinkClient client, MavlinkMessage message, CancellationToken ct = default)
//	{
//		switch (message)
//		{
...
//	// тут такий варіант, який вже делегує сам sender
